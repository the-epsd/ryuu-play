...
import { SuperType, CardTag, SpecialCondition, BoardEffect, CardType, TrainerType } from '../card/card-types';
import { EnergyCard } from '../card/energy-card';
import { PokemonCard } from '../card/pokemon-card';
import { PowerType } from '../card/pokemon-types';
import { TrainerCard } from '../card/trainer-card';
import { DealDamageEffect, PutDamageEffect, HealTargetEffect, DiscardCardsEffect, AddSpecialConditionsEffect, AfterDamageEffect, ApplyWeaknessEffect, PutCountersEffect } from '../effects/attack-effects';
