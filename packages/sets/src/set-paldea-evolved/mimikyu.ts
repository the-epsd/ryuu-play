import { PokemonCard, Stage, CardType, PowerType, StoreLike, State, Effect, PutDamageEffect, StateUtils, GamePhase, CardTag, PowerEffect, AttackEffect, PutCountersEffect } from "@ptcg/common";
