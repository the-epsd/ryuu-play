import { StoreLike, State, Effect, AddSpecialConditionsEffect, AttackEffect, CardType, CheckProvidedEnergyEffect, PokemonCard, SpecialCondition, Stage } from '@ptcg/common';
