import { StoreLike, State, Effect, AttackEffect, BoardEffect, CardTarget, CardType, ChooseCardsPrompt, EndTurnEffect, GameError, GameMessage, MoveEnergyPrompt, PlayerType, PlayPokemonEffect, PokemonCard, PowerEffect, PowerType, ShowCardsPrompt, ShuffleDeckPrompt, SlotType, Stage, StateUtils, SuperType, TrainerType } from '@ptcg/common';
...
export class Gallade extends PokemonCard {
  ...
  public reduceEffect(store: StoreLike, state: State, effect: Effect): State {
    ...
    if (effect instanceof EndTurnEffect && effect.player.marker.hasMarker(this.BUDDY_CATCH_MARKER, this)) {
      const player = effect.player;
      player.marker.removeMarker(this.BUDDY_CATCH_MARKER, this);
    }
