import { StoreLike, State, Effect, Card, GameError, GameMessage, TrainerCard, TrainerEffect, TrainerType } from '@ptcg/common';
...
export class RedeemableTicket extends TrainerCard {
  ...
  public text: string = 'Count your Prize cards and shuffle them face down, then put them at the bottom of your deck. If you do, add that many cards from the top of your deck to your Prize cards.';
