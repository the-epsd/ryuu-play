import { TrainerCard, TrainerType, StoreLike, State, Effect, TrainerEffect, PlayerType, EnergyCard, GameError, GameMessage, MoveEnergyPrompt, SlotType, SuperType, StateUtils } from "@ptcg/common";
