import { PokemonCard, Stage, CardTag, CardType, StoreLike, State, Effect, WAS_ATTACK_USED, CardTarget, PlayerType, SlotType, ChoosePokemonPrompt, GameMessage } from "@ptcg/common";
...
export class TeamRocketsWobbuffet extends PokemonCard {
  ...
  public fullName: string = 'Team Rocket\'s Wobbuffet SV10';
