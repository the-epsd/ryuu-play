import { PokemonCard, Stage, CardType, StoreLike, State, Effect, WAS_ATTACK_USED, ChoosePokemonPrompt, GameMessage, PlayerType, SlotType, DealDamageEffect } from "@ptcg/common";
...
export class Primeape extends PokemonCard {
  ...
  public fullName: string = 'Primeape SV10';
