import { StoreLike, State, AttackEffect, StateUtils, GameError, GameMessage, CardList, SuperType, PokemonCard, ShowCardsPrompt, SHUFFLE_DECK, ChooseAttackPrompt, Attack, GameLog, DealDamageEffect, Stage, CardTag, CardType, Effect, WAS_ATTACK_USED, ADD_CONFUSION_TO_PLAYER_ACTIVE } from "@ptcg/common";
...
export class TeamRocketsPersianex extends PokemonCard {
  ...
  public fullName: string = 'Team Rocket\'s Persian ex SV10';
