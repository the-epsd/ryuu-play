import { PokemonCard, Stage, CardTag, CardType, StoreLike, State, Effect, WAS_ATTACK_USED, Card, ChooseCardsPrompt, GameMessage, SuperType, TrainerType, SHOW_CARDS_TO_PLAYER, MOVE_CARDS_TO_HAND, SHUFFLE_DECK } from "@ptcg/common";
...
export class TeamRocketsMareep extends PokemonCard {
  ...
  public fullName: string = 'Team Rocket\'s Mareep SV10';
