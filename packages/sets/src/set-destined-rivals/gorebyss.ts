import { PokemonCard, Stage, CardType, StoreLike, State, Effect, WAS_ATTACK_USED, SuperType, EnergyType, CONFIRMATION_PROMPT, AttachEnergyPrompt, GameMessage, PlayerType, SlotType, StateUtils } from "@ptcg/common";
...
export class Gorebyss extends PokemonCard {
  ...
  public fullName: string = 'Gorebyss SV10';
