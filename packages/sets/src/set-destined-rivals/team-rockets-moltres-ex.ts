import { PokemonCard, Stage, CardTag, CardType, StoreLike, State, Effect, WAS_ATTACK_USED, EndTurnEffect, StateUtils, PlayerType, SuperType, ChooseCardsPrompt, GameMessage, EnergyType, MOVE_CARDS } from "@ptcg/common";
...
export class TeamRocketsMoltresex extends PokemonCard {
  ...
  public fullName: string = 'Team Rocket\'s Moltres ex SV10';
